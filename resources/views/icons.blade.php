				...
				<div class="sidebar-wrapper" style=" overflow-x:hidden; overflow-y: hidden;">
					<div class="logo">
						<a href="#home" class="simple-text">
							 <img src="{{url('img/logo4.png ')}}" style="max-width: 500px; height: 80px;">
						</a>
					</div>
					...
					<ul class="nav">
						...
						<li>
							...
							<label for="check01">
								...
								<p style="position:relative; top:6px;">PORTAL</p>
							</label>
						</li>
						...
						<li>
							...
							<ul class="submenu">
								<li><a href="#">Saldo de Dotações</a></li>
									<li><a href="#">Agenda Orçamentária</a></li>
									<li><a href="#">Formulários</a></li>
									<li><a href="#">Manual de Alterações</a></li>
									<li><a href="#">Leis e Decretos</a></li>
							</ul>
						</li>
						...
						<li>
							...
							<ul class="submenu">
								<li><a href="{{ route('formularios') }}">Formulários</a></li>
								<li><a href="#">Leis e Decretos</a></li>
							</ul>
						</li>
						...
						<li>
							...
							<label for="check05">
								...
								<p style="position:relative; top:6px;">COMITÊ GESTOR</p>
							</label>
						</li>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse">
							<ul class="nav navbar-nav navbar-left">
								...
								<button class="arrow left" style="left:30px">
									<svg width="30px" height="30px" viewBox="0 0 50 80" xml:space="preserve"  onclick="goBack()">
										<polyline fill="none" stroke="#000" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" points="45.63,75.8 0.375,38.087 45.63,0.375 "/>
									</svg>  
								</button>
								<button class="arrow right" style="left:145px">
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" onclick="goForward()" width="30px" height="30px" viewBox="0 0 50 80" xml:space="preserve">
										<polyline fill="none" stroke="#000" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" points="0.375,0.375 45.63,38.087 0.375,75.8 "/>
									</svg>
								</button>
