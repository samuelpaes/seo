					...
					<div class="row" >
						<div class="col-md-6" >
							<div class="card" style="height:430px">
								<div class="header">
								<h4 class="title" style="text-align:center">SALDO DE DOTAÇÕES</h4>
					...
					<div class="row" >
						<div class="col-md-4">
							<div class="card" style="height:350px">
								<div class="header">
									<h4 class="title" style="text-align:center">PROGRAMAS E DOTAÇÕES</h4>
									<!--<p class="category" style="text-align:center">Programas e suas dotações</p>-->
								</div>
								<div class="content" >
								<canvas id="chart-area" style="display: block; width: 100%; height: 250px;" width="593" height="296" class="chartjs-render-monitor"></canvas>
								<script>
									/*var randomScalingFactor = function() {
										return Math.round(Math.random() * 100);
									};*/
									//alert(<?php echo count($programas)?>);
									var colors = [];
									for(var i = 0; i < <?php echo count($programas)?>; i++) {
