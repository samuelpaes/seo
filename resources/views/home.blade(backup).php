...
::-webkit-scrollbar-thumb:hover {
 background: rgba(255, 255, 255, 0.9);
	...
	<body>
				...
				<nav class="navbar navbar-default navbar-fixed" style="height:50px; z-index:10">
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse">
							<ul class="nav navbar-nav navbar-left" style="position:relative; top:-8px; display: inline;">
								<img src="{{url('img/logo.png ')}}" style="max-width: 200px; height: 35px; color:#000; position:absolute; top:10px;">
							</ul>
							<ul class="nav navbar-nav navbar-right" style="position:relative; top:-8px; display: inline;">
								<li>
								   <a href="">
								...
								<li>
									...
									<div class="arrow-down" onclick="this.classList.toggle('active')" >
										<label for="check02" >
											<p style="position:relative; top:15px;color:#40609d ">ORÇAMENTO</p>
										</label>
									</div>
									<ul class="submenu">
