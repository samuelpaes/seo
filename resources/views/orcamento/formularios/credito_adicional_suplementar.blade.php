										...
										<div class="content table-responsive table-full-width" style="font-size:12px; overflow-x:auto;" >
											<table class="table table-hover table-striped" id="tabela_anular" name="tabela_anular" style='font-size:98%'>
												...
												<tbody>
													...
													<tr style="height:auto;">
														<td style="width:75px; "><input name="anl_unidade_executora[{{$i}}]" value="{{$dotacao['unidade_executora']}}"><div class="form-control" style='flex-wrap:nowrap; display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center; margin:-30px'>{{$dotacao['unidade_executora']}}</div></input></td>
														<td style="width:120px; "><input name="anl_classificacao_funcional[{{$i}}]" value="{{$dotacao['classificacao_funcional_programatica']}}"><div class="form-control" style=' flex-wrap:nowrap; display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center; margin:-30px' id="classificacao_anl-{{$i}}">{{$dotacao['classificacao_funcional_programatica']}}</div></input></td>
														<td style="width:100px; "><input name="anl_natureza_despesa[{{$i}}]" value="{{$dotacao['natureza_de_despesa']}}"><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center; margin:-30px' id="natureza_anl-{{$i}}">{{$dotacao['natureza_de_despesa']}}</div></input></td>
														<input type="hidden" value="{{$i}}" name="anl_id[{{$i}}]" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; width:auto; text-align:center; margin:-30px'></input>
														<td style="width:100px; "><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; width:auto; text-align:center; margin:-30px'>	
															<select class="form-control" name="anl_vinculo[{{$i}}]" onclick="anl_atualizar_vinculo(this, {{$i}})"  onmouseout="anl_atualizar_vinculo(this, {{$i}})" onmouseover="sup_atualizar_vinculo(this, {{$i}})" onkeyup="anl_atualizar_vinculo(this, {{$i}})" id="vinculo_anl-{{$i}}" style="width:auto; height:auto;position:relative; top:-5px; margin:-30px">
																<option selected></option>	
														...
														<td style="width:65px; "><input value="{{$dotacao['codigo_dotacao']}}" name='anl_codigo_dotacao[]' hidden></input><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; width:auto; text-align:center; margin:-30px'>{{$dotacao['codigo_dotacao']}}</div></td>
