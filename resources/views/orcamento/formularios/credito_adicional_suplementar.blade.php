									...
									<div class="row flex-nowrap">				
										...
										<div class="content table-responsive table-full-width" style="font-size:12px; overflow-x:auto;" >
											<table class="table table-hover table-striped" id="tabela_anular" name="tabela_anular" style='font-size:98%'>
												<thead>
													<tr style="height:100px">
														<th style=""><label style="flex-wrap:nowrap; display: inline-block; width: 90px; line-height: 1.5; text-align:center; color:#000;  margin-left:-30px; margin-right:-30px"><b>Unidade Executora</b></label></th>
														<th style="text-align:center; "><label style="flex-wrap:nowrap; display: inline-block; width: 120px; line-height: 1.5; text-align:center; color:#000;  margin-left:-30px; margin-right:-30px"><b>Classificação Funcional Programática</b></label></th>
														<th style=""><label style="flex-wrap:nowrap; display: inline-block; width: 100px; line-height: 1.5; text-align:center; color:#000;  margin-left:-30px; margin-right:-30px"><b>Natureza De Despesa</b></label></th>
														<th style=""><label style="flex-wrap:nowrap; display: inline-block; width: 100px; line-height: 1.5; text-align:center; color:#000;  margin-left:-30px; margin-right:-30px"><b>Vínculo</b></label></th>
														<th style=""><label style="flex-wrap:nowrap; display: inline-block; width: 50px; line-height: 1.5; text-align:center; color:#000; margin-left:-30px; margin-right:-30px"><b>Dotação</b></label></th>
														<th style=""><label style="flex-wrap:nowrap; display: inline-block; width: 100px; line-height: 1.5; text-align:center; color:#000;  margin-left:-30px; margin-right:-30px"><b>Valor</b></label></th>
														<th style=""><label style="flex-wrap:nowrap; display: inline-block; width: 100px; line-height: 1.5; text-align:center; color:#000;  margin-left:-30px; margin-right:-30px"><b>Recurso</b></label></th>
												...
												<tbody>
													...
													<tr style="height:auto;">
														<td style="width:75px; "><input name="anl_unidade_executora[{{$i}}]" value="{{$dotacao['unidade_executora']}}"><div class="form-control" style='flex-wrap:nowrap; display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center; margin-left:-30px; margin-right:-30px'>{{$dotacao['unidade_executora']}}</div></input></td>
														<td style="width:120px; "><input name="anl_classificacao_funcional[{{$i}}]" value="{{$dotacao['classificacao_funcional_programatica']}}"><div class="form-control" style=' flex-wrap:nowrap; display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center;  margin-left:-30px; margin-right:-30px' id="classificacao_anl-{{$i}}">{{$dotacao['classificacao_funcional_programatica']}}</div></input></td>
														<td style="width:100px; "><input name="anl_natureza_despesa[{{$i}}]" value="{{$dotacao['natureza_de_despesa']}}"><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center;  margin-left:-30px; margin-right:-30px' id="natureza_anl-{{$i}}">{{$dotacao['natureza_de_despesa']}}</div></input></td>
														<input type="hidden" value="{{$i}}" name="anl_id[{{$i}}]" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; width:auto; text-align:center;  margin-left:-30px; margin-right:-30px'></input>
														<td style="width:100px; "><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; width:auto; text-align:center;  margin-left:-30px; margin-right:-30px'>	
														...
														<td style="width:65px; "><input value="{{$dotacao['codigo_dotacao']}}" name='anl_codigo_dotacao[]' hidden></input><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; width:auto; text-align:center;  margin-left:-30px; margin-right:-30px'>{{$dotacao['codigo_dotacao']}}</div></td>
														...
														<td hidden><input class="form-control" name='anl_dotacao[{{$i}}]' value="{{'R$ '.number_format($dotacao['dotacao'], 2, ',', '.')}}" style='display:hidden; border:none; background:none; color:#000; font-weight:normal;width:auto; text-align:center;  margin-left:-30px; margin-right:-30px'></input></td>
													</tr>
													<?php 
