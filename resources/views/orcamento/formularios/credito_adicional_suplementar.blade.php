											...
											<table class="table table-hover table-striped" id="tabela_anular" name="tabela_anular" style='font-size:98%'>
												<thead>
													<tr style="height:100px">
														...
														<th style=""><label style="flex-wrap:nowrap; display: inline-block; width: 100px; line-height: 1.5; text-align:center; color:#000; margin-right:7px;"><b>Natureza De Despesa</b></label></th>
