										...
										<div class="content table-responsive" style=" font-size:12px;" >
											<table class="table table-hover table-striped" id="tabela_anular" name="tabela_anular" style='font-size:98%'>
												...
												<tbody>
													...
													<tr style="height:auto;">
														<td><input name="anl_unidade_executora[{{$i}}]" value="{{$dotacao['unidade_executora']}}"><div class="form-control" style='flex-wrap:nowrap; display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center;'>{{$dotacao['unidade_executora']}}</div></input></td>
														<td><input name="anl_classificacao_funcional[{{$i}}]" value="{{$dotacao['classificacao_funcional_programatica']}}"><div class="form-control" style=' flex-wrap:nowrap; display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center;' id="classificacao_anl-{{$i}}">{{$dotacao['classificacao_funcional_programatica']}}</div></input></td>
														<td><input name="anl_natureza_despesa[{{$i}}]" value="{{$dotacao['natureza_de_despesa']}}"><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; height:auto; width:auto; text-align:center;' id="natureza_anl-{{$i}}">{{$dotacao['natureza_de_despesa']}}</div></input></td>
														...
														<td><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; width:auto; text-align:center;'>	
														...
														<td><input value="{{$dotacao['codigo_dotacao']}}" name='anl_codigo_dotacao[]' hidden></input><div class="form-control" style='display:hidden; border:none; background:none; color:#000; font-weight:normal; width:auto; text-align:center;'>{{$dotacao['codigo_dotacao']}}</div></td>
														<td><input name="anl_valor[{{$i}}]" value="{{$dotacao['valor']}}" placeholder="R$ 0,00" onkeypress="anl_atualizar_valor(this, {{$i}})" onkeydown="anl_atualizar_valor(this, {{$i}})" onkeyup="anl_atualizar_valor(this, {{$i}})" onclick="anl_atualizar_valor(this, {{$i}})" onmouseout="anl_atualizar_valor(this, {{$i}})"  onmouseover="anl_atualizar_valor(this, {{$i}})" id="valor_anl-{{$i}}" class="form-control"></input></td>
														<td><textarea name='anl_recurso[{{$i}}]' onkeypress="anl_atualizar_recurso(this, {{$i}})" onkeydown="anl_atualizar_recurso(this, {{$i}})" onkeyup="anl_atualizar_recurso(this, {{$i}})"  onclick="anl_atualizar_recurso(this, {{$i}})" onmouseout="anl_atualizar_recurso(this, {{$i}})" onmouseover="anl_atualizar_recurso(this, {{$i}})" id="recurso_anl-{{$i}}" class="form-control" style="width:100%; height:40px;  text-transform: uppercase;">{{$dotacao['recurso']}}</textarea></td>
														<td><button type="button" style="width:100%; color:#000" id="rem_anular" onclick="removerLinha(this, this.id)"><div class="outer"><div class="inner"><label class="label_remove">Excluir</label></div></div></input></td>
