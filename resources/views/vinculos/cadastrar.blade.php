			...
			<div class="container-fluid">
				<div class="row">
					...
					<!--Cadastrar Vínculo -->
							...
							<div class="card">
								<div class="header">
									<h5 class="title">Cadastrar Vínculo</h5>
									<br>
								</div>	
								<div class="content">
									<form method="POST" action="{{route ('inserirVinculos') }}">	
										@csrf
										@method('POST')								
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Código</label>
													<input type="text" name="codigo" id="codigo" maxlength="11"  onkeyup="mascaraCodigoDespesa( this, cDespesa );" class="form-control{{ $errors->has('registro') ? ' is-invalid' : '' }}" required autofocus>																		
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
