...
Route::middleware(['auth'])->group(function () {
	...
	Route::get('dotacao-orcamentaria/cadastrarNovoExercicio', 'DotacaoOrcamentariaController@cadastrarNovoExercício', function () {})->name('cadastrarNovoExercicioDotacaoOrcamentaria');
